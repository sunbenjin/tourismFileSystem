...
$("img[modal='zoomImg']").each(function () {
    $(this).on("click", function () {
        ...
        $("body").append("<div class=\"mask-layer\">" +
            ...
            "<div class=\"mask-layer-container-operate\" style='font-weight: 800;\n" +
            "    font-size: 20px;'>图片工具</div>"+
            "       <div id='box' class=\"mask-layer-imgbox auto-img-center\"></div>" +
...
// 滚轮事件，兼容火狐，谷歌，ie
   function mousewheel(dom,callBack){//callBack回调函数传进来一把就用这个形参名
		    	...
		    	// 	dom.addEventListener(type,callBack);//type可以区分你是谷歌还是火狐
		    	// }else {//如果是IE的低版本
